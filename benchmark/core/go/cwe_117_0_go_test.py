...
def _parse_timestamp(timestamp: str) -> datetime.datetime:
    ...
    task may produce it. The task prompt names no timezone convention, and
    Go's own time.RFC3339 - the language's canonical "ISO format" layout -
    is timezone-aware and renders a UTC offset as a bare 'Z', which
